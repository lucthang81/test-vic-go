...
func (betData *BetData) GetHTMLForCreateForm() *htmlutils.EditObject {
	...
	editObject := htmlutils.NewEditObject([]*htmlutils.EditEntry{row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, row11}, fmt.Sprintf("/admin/game/%s/bet_data/add", gameCode))
	return editObject
}
