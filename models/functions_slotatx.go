...
func SlotatxChooseMoneyPerLine(models *Models, data map[string]interface{}, playerId int64) (
	map[string]interface{}, error) {

	moneyPerLine := utils.GetInt64AtPath(data, "moneyPerLine")

	slotGame, player, err := GeneralCheckGslot(
		models, data, playerId, slotatx.SLOTATX_GAME_CODE)
	if err != nil {
		return nil, err
	}
...
func SlotatxChoosePaylines(models *Models, data map[string]interface{}, playerId int64) (
	map[string]interface{}, error) {
...
func SlotatxGetHistory(models *Models, data map[string]interface{}, playerId int64) (
	map[string]interface{}, error) {
...
func SlotatxSpin(models *Models, data map[string]interface{}, playerId int64) (
	map[string]interface{}, error) {
...
func SlotatxSelectSmall(
	...
	err = slotatx.SelectSmall(slotGame, player)
	if err != nil {
		return nil, err
	} else {
		return nil, nil
...
func SlotatxSelectBig(
	...
	err = slotatx.SelectBig(slotGame, player)
	if err != nil {
		return nil, err
	} else {
		return nil, nil
